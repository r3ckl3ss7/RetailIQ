            ...
            <div className="quick-actions">
              ...
              <div className="actions-grid">
                <button
                  ...
                  onClick={() => navigate("/products", { state: { showAddForm: true } })}
                >
                  <svg
                    width="24"
                    height="24"
                ...
                <button className="action-card" id="action-view-analytics" onClick={() => navigate("/products")}>
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                ...
                <button className="action-card" id="action-settings" onClick={() => navigate("/business")}>
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
